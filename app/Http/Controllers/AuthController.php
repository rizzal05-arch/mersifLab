    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            if ($role === 'teacher' && !$user->isTeacher()) {
                ...
                ])->with('error_type', 'wrong_role_teacher')->with('login_role', $role)->onlyInput('email');
            }
            ...
            if ($role === 'student' && !$user->isStudent()) {
                ...
                ])->with('error_type', 'wrong_role_student')->with('login_role', $role)->onlyInput('email');
            }
        ...
        ])->with('login_role', $role)->onlyInput('email');
    }
