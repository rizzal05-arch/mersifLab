...
class ActivityLog extends Model
{
    ...
    public function getActionIconAttribute(): string
    {
        return match($this->action) {
            ...
            'class_created' => 'fas fa-book text-success',
            'class_updated' => 'fas fa-edit text-primary',
            'class_deleted' => 'fas fa-trash text-danger',
            'module_created' => 'fas fa-file-alt text-success',
            'module_updated' => 'fas fa-edit text-primary',
            'module_deleted' => 'fas fa-trash text-danger',
            'course_deleted' => 'fas fa-trash text-danger',
            'course_featured' => 'fas fa-thumbtack text-warning',
            'course_unfeatured' => 'fas fa-thumbtack text-secondary',
            'teacher_banned' => 'fas fa-ban text-danger',
            'teacher_unbanned' => 'fas fa-user-check text-success',
            'teacher_deleted' => 'fas fa-trash text-danger',
            'student_banned' => 'fas fa-ban text-danger',
            'student_unbanned' => 'fas fa-user-check text-success',
            'student_deleted' => 'fas fa-trash text-danger',
            'category_created' => 'fas fa-folder-plus text-success',
            'category_updated' => 'fas fa-edit text-primary',
            'category_deleted' => 'fas fa-trash text-danger',
            'module_approved' => 'fas fa-check-circle text-success',
            'module_rejected' => 'fas fa-times-circle text-danger',
            'admin_activity' => 'fas fa-cog text-info',
