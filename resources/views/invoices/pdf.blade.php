    ...
    <div class="invoice-container">
            ...
            <div class="right">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge">{{ $invoice->status === 'paid' ? 'Sudah Dibayar' : 'Belum Dibayar' }}</span>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        @if($invoice->status === 'paid')
            <div class="status-paid">
                ...
                @if($invoice->paid_at)
                    <small>Dibayarkan pada: {{ $invoice->paid_at->format('d F Y H:i') }}</small>
                @endif
            </div>
        @elseif($invoice->status === 'pending')
            <div class="status-pending">
                <h4>⏰ MENUNGGU PEMBAYARAN</h4>
                <p>Silakan lakukan pembayaran sebelum {{ $invoice->due_date->format('d F Y') }}</p>
            </div>
        @endif
        ...
        @if($invoice->status === 'pending')
            <div class="payment-instructions">
                <h4><strong>Informasi Pembayaran:</strong></h4>
                ...
                <p>Setelah melakukan transfer, segera konfirmasi pembayaran via WhatsApp:</p>
                <p><strong>WhatsApp: 088806658440</strong></p>
                <p><em>PENTING: Simpan bukti transfer untuk verifikasi jika diperlukan.</em></p>
            </div>
        @endif

        <!-- Footer -->
        <div class="footer">
            <p>Invoice ini sah dan telah dibuat oleh sistem MersifLab.</p>
            <p>Jika ada pertanyaan, hubungi: support@mersiflab.com</p>
