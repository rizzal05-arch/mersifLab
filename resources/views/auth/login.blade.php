...
<a href="{{ route('auth.google') }}" class="w-full bg-white border-2 border-gray-300 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded flex items-center justify-center">
