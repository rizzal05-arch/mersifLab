                ...
                <div class="auth-card">
                    ...
                    <ul class="nav nav-tabs auth-tabs mb-4" role="tablist">
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link {{ !session('active_tab') || session('active_tab') === 'student' ? 'active' : '' }} w-100" id="student-tab" data-bs-toggle="tab" data-bs-target="#student" type="button" role="tab">
                                Student
                            </button>
                        </li>
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link {{ session('active_tab') === 'teacher' ? 'active' : '' }} w-100" id="teacher-tab" data-bs-toggle="tab" data-bs-target="#teacher" type="button" role="tab">
                                Teacher
                            </button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <!-- Student Login -->
                        <div class="tab-pane fade {{ !session('active_tab') || session('active_tab') === 'student' ? 'show active' : '' }}" id="student" role="tabpanel">
                            @if(session('success'))
