        ...
        <div class="col-md-10 offset-md-1">
            <div class="card teacher-form-card">
                <div class="card-header teacher-form-header">
                    <h5 class="mb-0">
                        <i class="fas fa-align-left me-2"></i>Edit Text Module
                    </h5>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <small class="form-text text-muted">
                                        Estimasi waktu yang dibutuhkan siswa untuk menyelesaikan modul ini
                                    </small>
...
<script>
    ...
    if (typeof tinymce === 'undefined') {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Looking for form with action containing "update"');
