                    ...
                    <form action="{{ route('teacher.chapters.store', $class) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="What will students learn in this chapter?">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('order') is-invalid @enderror" 
                                   ...
                                   value="{{ old('order', $class->chapters()->count()) }}">
                            <small class="text-muted">Chapters will be displayed in this order</small>
                            @error('order')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
