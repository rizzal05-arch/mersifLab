                ...
                <div class="detail-right">
                    ...
                    <div class="detail-item">
                        ...
                        <p class="value">
                            ...
                            @elseif(isset($invoice) && $invoice->invoiceItems && $invoice->invoiceItems->count() === 1)
                                {{ $invoice->invoiceItems->first()->item_name ?? 'Course tidak ditemukan' }}
                            @else
                        ...
                        <tbody>
                            ...
                            @else
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>
                                        <strong>{{ isset($purchase) ? ($purchase->course->name ?? 'Course tidak ditemukan') : ($invoice->invoiceItems->first()->item_name ?? 'Course tidak ditemukan') }}</strong>
                                        <br>
