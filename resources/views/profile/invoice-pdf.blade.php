...
<body>
    <div class="invoice-container">
        ...
        <div class="invoice-time">
            ...
            <div class="time-item">
                <div class="label">Waktu Pembayaran</div>
                <div class="value">
                    @if($purchase->paid_at)
        ...
        <div class="invoice-details">
            <div class="detail-section">
                <div class="detail-item">
                    ...
                    <div class="value">{{ $purchase->payment_method ?? 'Tidak ditentukan' }}</div>
                </div>
                <div class="detail-item">
            ...
            <div class="detail-section">
                ...
                <div class="detail-item">
                    ...
                    <div class="value">{{ $purchase->course->name ?? 'Course tidak ditemukan' }}</div>
                </div>
            </div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>
                            <div class="course-name">{{ $purchase->course->name ?? 'Course tidak ditemukan' }}</div>
        ...
        <!-- Footer -->
        <div class="footer">
            <p>Invoice ini dibuat secara otomatis oleh sistem MersifLab</p>
