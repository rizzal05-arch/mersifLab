...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('images/favicon.png') }}?v={{ file_exists(public_path('images/favicon.png')) ? md5_file(public_path('images/favicon.png')) : '1' }}">
    <link rel="shortcut icon" href="{{ asset('images/favicon.png') }}?v={{ file_exists(public_path('images/favicon.png')) ? md5_file(public_path('images/favicon.png')) : '1' }}">
    <link rel="apple-touch-icon" href="{{ asset('images/favicon.png') }}?v={{ file_exists(public_path('images/favicon.png')) ? md5_file(public_path('images/favicon.png')) : '1' }}">
